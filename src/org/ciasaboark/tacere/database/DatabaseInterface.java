...
public class DatabaseInterface {
	...
	private Prefs prefs = new Prefs(mAppContext);
	...
	private void pruneRemovedEvents(long cutoff) {
		...
		String[] projection = new String[] { "title", "begin", "end", "description",
				"displayColor", "allDay", "availability", "_id", "event_id" };
		Cursor cal_cursor = Instances.query(mAppContext.getContentResolver(), projection, begin,
				end);
